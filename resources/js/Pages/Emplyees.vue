<template>
  <nav class="p-4">
    ...
    <Modal :isOpen="modal.createEmployee" @close="hideModalToCreateEmployee">
      <EmployeeForm :supervisors="supervisors" :subordinates="subordinates" :others="others" @employee-created="newEmployeeCreated" :employee="clearFormTemplate" />
    </Modal>
  </nav>
  <div class="p-4">
    <div>
      <EmployeeItem @change-employee-status="toggleEmployeeStatus" class="container" v-for="employee in localEmployees"
      ...
      <Modal :isOpen="modal.editEmployee" @close="hideModalToCreateEmployee">
        <EmployeeForm :supervisors="supervisors" :subordinates="subordinates" :others="others" :edit="true"
...
export default {
  ...
  methods: {
    ...
    async showEditForm(employee) {
      ...
      console.log(this.supervisors, this.subordinates, this.others);
    },
